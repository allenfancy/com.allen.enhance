...
public abstract class AbstractDynamicDataSourceProxy extends AbstractDataSource
    ...
    public Connection getConnection() throws SQLException {
        return (Connection) Proxy.newProxyInstance(
                org.com.allen.enhance.basic.writeAndRead.plan3.ConnectionProxy.class
                        .getClassLoader(),
                new Class[] {org.com.allen.enhance.basic.writeAndRead.plan3.ConnectionProxy.class},
    ...
    private class RWConnectionInvocationHandler implements InvocationHandler {
        ...
        private Connection getTargetConnection(Method operation, Object[] args)
                throws SQLException {
            ...
            if (this.target == null) {
                ...
                if (this.autoCommit != null
                        && this.autoCommit.booleanValue() != this.target.getAutoCommit()) {
                ...
                if (logger.isDebugEnabled()) {
                    logger.debug("Using existing database connection for operation '"
                            + operation.getName() + "'");
                }
            }
