package com.allen.enhance.swagger.controller.web;
...
public class UserController {
    ...
    @ApiOperation(value = "保存用户信息", httpMethod = "POST", response = UserInfoRes.class,
            notes = "第三方用户信息保存")
    ...
    @ApiOperation(value = "获取用户信息", httpMethod = "GET", response = InfoRes.class,
            notes = "根据用户名获取用户信息")
    ...
    @ApiOperation(value = "获取用户信息", httpMethod = "DELETE", response = InfoRes.class,
            notes = "根据用户名获取用户信息")
